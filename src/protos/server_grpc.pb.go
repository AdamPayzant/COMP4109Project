...
func (c *serverClient) GetToken(ctx context.Context, in *Username, opts ...grpc.CallOption) (*AuthKey, error) {
	out := new(AuthKey)
	err := c.cc.Invoke(ctx, "/Server/getToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serverClient) UpdateIP(ctx context.Context, in *IPupdate, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/Server/UpdateIP", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serverClient) UpdateKey(ctx context.Context, in *KeyUpdate, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/Server/UpdateKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serverClient) SearchUser(ctx context.Context, in *UserQuery, opts ...grpc.CallOption) (*UserList, error) {
	out := new(UserList)
	err := c.cc.Invoke(ctx, "/Server/searchUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serverClient) GetUser(ctx context.Context, in *Username, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
	err := c.cc.Invoke(ctx, "/Server/getUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
